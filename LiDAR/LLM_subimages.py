...
def extract_image_for_landing_zone(image, landing_zone, fx, fy, cx, cy, padding=30):
    ...
    return resized_image, (min_v, min_u, max_v, max_u)
...
def find_roofs(pcd_file, seg_img):
    ...
    landing_zones = cluster_landing_zones(flat_areas, distance_threshold=5.0, min_cluster_size=250, z_threshold=0.2)
